...
![Version: 3.5.3](https://img.shields.io/badge/Version-3.5.3-informational?style=flat-square) ![AppVersion: 7](https://img.shields.io/badge/AppVersion-7-informational?style=flat-square)
...
| providers.aks.admissionControllerSelectors | bool | `false` | Use specific selectors in Admission Controller to avoid conflicts with build-in controller. |
